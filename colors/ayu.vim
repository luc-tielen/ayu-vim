...
" originally: let s:palette.comment   = {'dark': "#5C6773",  'light': "#ABB0B6",  'mirage': "#5C6773"}
let s:palette.comment   = {'dark': "#9199a2",  'light': "#ABB0B6",  'mirage': "#9199a2"}
...
"originally: let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.guide     = {'dark': "#777777",  'light': "#D9D8D7",  'mirage': "#777777"}
